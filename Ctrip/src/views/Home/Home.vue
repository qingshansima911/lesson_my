    ...
    <div class="page_body">
      ...
      <van-skeleton title :row="3" :loading="state.loading">
        <div class="post-wrapper">
          <div class="post-col">
            <post v-for="item in articleLeft" :key="item.ar_id" @click="gotoDetail(item.ar_id)" :post="item" />
          </div>
          <div class="post-col">
            <post v-for="item in articleRight" :key="item.ar_id" @click="gotoDetail(item.ar_id)" :post="item" />
          </div>
        </div>
      </van-skeleton>
    </div>
